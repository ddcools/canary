...
class RidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rider" do
    assert_difference('Rider.count') do
      post riders_url, params: { rider: { age: @rider.age, bike: @rider.bike, city: @rider.city, name: @rider.name } }
    end
  ...
  test "should update rider" do
    patch rider_url(@rider), params: { rider: { age: @rider.age, bike: @rider.bike, city: @rider.city, name: @rider.name } }
